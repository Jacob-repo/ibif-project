<div>
    <flux:modal name="create-post" variant="flyout">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Create Post</flux:heading>
                <flux:text class="mt-2">Add details for the post.</flux:text>
            </div>

            <flux:input wire:model="title" label="Title" maxlength="32" placeholder="Your title" />

            <flux:textarea wire:model="body" label="Body" maxlength="64" rows="7" placeholder="Your body" />
